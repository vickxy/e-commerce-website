...
<!--         <p>Discover new original artwork from around the world</p>-->
         <?php $rows = count($this->cart->contents()); ?>
          <?= anchor('Shopingcart',' cart '.$rows,['class'=>'btn btn-info fixcart fa fa-shopping-cart']); ?>
    </div>  
  </div>

  <?php if(count($result)):?>
    <?php foreach($result as $head_data) :?>
 <?php echo form_open('Shopingcart/add',['class'=>'form-horizontal']);?>
    <div class="col-lg-4 col-md-4 c" style="height:400px;">
          <div class="imagebox">
              ...
              <div class="shiftright" style="float:right;"><?= anchor('Stuff','Buy',['class'=>'btn btn-info fancybox-buttons '])?>  </div>
               <?php
...
<!--                  <p><?php echo form_submit('', 'Add to Cart'); ?></p>  -->
                                <a  type="submit" class="btn btn-info fa fa-shopping-cart " style="font-size:18px;"> Add to Cart</a> 
